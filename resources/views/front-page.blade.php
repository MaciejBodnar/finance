    ...
    <section class="bg-[#122457]">
        <div class="relative">
            ...
            <div class="absolute bottom-0 w-full min-h-[322px]"
                ...
                <div class="grid grid-cols-3 py-24">
                    ...
                    <div>
                        ...
                        <button class="border-2 border-black">Umów się</button>
                    </div>
                    <div>
                        <p>Nasi księgowi w Hanwell są cały czas do Twojej dyspozycji – zadzwoń albo napisz,
                            by umówić się na spotkanie.
                            Zajmiemy się Twoją sprawą w sposób rzetelny i kompleksowy! </p>
                    </div>
                </div>
            </div>
