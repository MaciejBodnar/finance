    ...
    <section id="kontakt" class="relative py-16 md:py-24 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4">
            <div class="text-center">
                <h2 class="text-3xl md:text-5xl font-bold">Kontakt</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 justify-between gap-8 text-[#0b285f]">
                <div class="col-span-3">
                    <h3 class="font-semibold mb-3">Dane kontaktowe</h3>
                    <div class="flex gap-20">
                        <div class="text-[#233]">56 Boston Road<br>London W7 3TR</div>
                        <div class="text-[#233]"><a href="tel:+442088400422" class="hover:underline">+0208 840
                                0422</a><br><a href="mailto:info@optimumtaxfinance.co.uk"
                                class="hover:underline">info@optimumtaxfinance.co.uk</a></div>
                    </div>
                </div>
                <div>
                    <h3 class="font-semibold mb-3">Godziny Otwarcia</h3>
                    <div class="text-[#233] text-[15px]">Pon–Pt: 9.00 – 17.00<br>Sob: 9.00 – 13.00</div>
                </div>
            </div>
            ...
            <form action="#" method="post" class="space-y-5 text-sm mt-10">
