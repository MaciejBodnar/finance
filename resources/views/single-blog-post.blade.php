...
@section('content')
    <section class="bg-white">
        <div class="max-w-6xl px-4 lg:px-0 flex flex-row min-w-full justify-between gap-10 lg:gap-16">

            <article class="prose ml-100 my-28 max-w-6xl">
                <header class="mb-8">
                    <h1 class="text-[#0b285f] mb-40 text-3xl md:text-5xl font-extrabold leading-tight">
                        {{ $post['title'] ?? '' }}
                    </h1>
            ...
            <aside class="space-y-8">
                <div class="w-full h-72 md:min-h-[756px] min-w-[624px] rounded-md overflow-hidden">
